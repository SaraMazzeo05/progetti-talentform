...
Consigli:
Per usare il metodo controlPassword all’interno di deposit, whitdraw,
addInterest è sufficiente richiamare il metodo controlPassword(inserendogli come
parametro un int che sia una password da controllare). Si tenga presente che
controlPassword restituisce un boolean. Non è obbligatorio che il metodo
controlPassword sia posizionato nella classe prima dei metodi deposit, whitdraw,
addInterest.
*/

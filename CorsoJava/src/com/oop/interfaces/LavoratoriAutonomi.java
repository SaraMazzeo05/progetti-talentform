...
public class LavoratoriAutonomi implements IAvvocato, IPsicologa {
	...
	public static void main(String[] args) {
		...
		System.out.println("Lo stipendio mensile dell'avvocato è di: "+avvocato.getStipendiMesile());
		System.out.println("Lo stipendio mensile della psicologa è di: "+psicologa.getStipendiMesile());
